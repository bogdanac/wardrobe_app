      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ...stats.mostWornItems.map((item) => _buildItemRow(item)).toList(),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ...leastWorn.take(5).map((item) => _buildItemRow(item)).toList(),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ...stats.newestItems.map((item) => _buildItemRow(item)).toList(),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ...stats.favoriteOutfits.take(5).map((outfit) => _buildOutfitRow(outfit)).toList(),
          ],
        ),
      ),
    );
